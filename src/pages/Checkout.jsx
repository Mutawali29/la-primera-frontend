...
function Checkout() {
    ...
    const ConfirmationStep = () => (
        <div className="space-y-6">
            ...
            {/* Cart Items */}
            <div className="border border-gray-200 rounded-xl p-6 bg-gradient-to-r from-red-50 to-orange-50 border-red-200">
                <h3 className="text-lg font-semibold text-red-900 mb-4 flex items-center">
                    <svg className="w-5 h-5 mr-2 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012-2M15 13l-3 3m0 0l-3-3m3 3V8" />
                    </svg>
                    Items Pesanan
                </h3>
