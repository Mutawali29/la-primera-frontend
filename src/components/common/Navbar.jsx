                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-8">
                            ...
                            <NavLink to="/blog" className={getNavlinkClass} onClick={closeAllMenus}>Blog</NavLink>
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center space-x-6">
                                ...
                                <Link to="/checkout" onClick={closeAllMenus} className="relative flex items-center bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-orange-600 hover:to-orange-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
                                    ...
                                    Checkout
                                    {cartCount > 0 && <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold animate-bounce">{cartCount}</span>}
                                </Link>
                                    ...
                                    <button onClick={toggleProfileDropdown} className="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                        ...
                                        <div className="w-9 h-9">
                                            {user?.avatar ? (
                                                ...
                                                <div className="h-full w-full bg-gradient-to-br from-red-500 to-orange-500 rounded-full flex items-center justify-center text-white font-semibold text-base">
                ...
                {isMenuOpen && (
                    <div className="md:hidden animate-fade-in">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50">
                            ...
                            <NavLink to="/blog" className={getMobileNavlinkClass} onClick={closeAllMenus}>Blog</NavLink>
                            ...
                            {isAuthenticated ? (
                                <div className="border-t border-gray-200 pt-4 mt-4">
                                    ...
                                    <Link to="/checkout" onClick={closeAllMenus} className="relative flex items-center justify-center w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white px-3 py-3 rounded-lg text-sm font-medium hover:from-orange-600 hover:to-orange-700 transition-all duration-200 mx-3 mb-3 shadow-md">
                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.1 5M7 13l-1.1 5m0 0h4.4m0 0l1.1-5M7 13h10m-5 8a1 1 0 11-2 0 1 1 0 012 0zm8 0a1 1 0 11-2 0 1 1 0 012 0z" /></svg> Checkout
                                        {cartCount > 0 && <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">{cartCount}</span>}
                                    </Link>
