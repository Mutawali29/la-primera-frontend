      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {/* Menu Section */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-red-600 dark:text-red-400">{t('footer.menu')}</h4>
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/shop" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
                    {t('footer.shop')}
                  </Link>
                </li>
                <li>
            ...
            {/* Bantuan Section */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-red-600 dark:text-red-400">{t('footer.help')}</h4>
              <ul className="space-y-2">
                <li>
            ...
            {/* Follow Us Section */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-red-600 dark:text-red-400">{t('footer.followUs')}</h4>
              <div className="flex space-x-4">
                {/* Instagram - akun resmi @laprimera.fly */}
                <a
                  href="https://www.instagram.com/laprimera.fly"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram La-Primera"
                ...
                {/* WhatsApp */}
                <a
                  href="https://wa.me/6285137113391"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp La-Primera"
                  className="text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 transition-colors"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* TikTok - akun resmi @laprimera._ */}
                <a
                  href="https://www.tiktok.com/@laprimera._"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="TikTok La-Primera"
                  className="text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 transition-colors"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Pembayaran Section */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-red-600 dark:text-red-400">{t('footer.payment')}</h4>
